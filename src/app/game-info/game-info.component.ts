...
export class GameInfoComponent implements OnInit, OnChanges {
  cardAction = [
    ...
    { title: 'Math', description: 'You start to count with 1. Everyone has to keep counting. When theres the number 6 or a number which is divisible by 6 the current person has to say "Fire" until someone messes up, and has to drink!' },
